...
// const { getSignup, postSignup, editSignup, deleteSignup } = require('../controllers/signup.controllers');
const {postSign, getuser, deleteuser, edituser, forgetPassword} = require('../controllers/signup.controllers');
