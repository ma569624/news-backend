...
const { getTagline, postTagline, EditTagline, DeleteTagline, getTajaSamachar, postTajaSamachar, EditTajaSamachar, DeleteTajaSamachar } = require('../controllers/Tagline.controllers');
